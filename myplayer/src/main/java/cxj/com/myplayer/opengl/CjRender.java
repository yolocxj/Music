...
public class CjRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener{
    ...
    public CjRender(Context context)
    {
    ...
    {
        String vertexSource = CjShaderUtil.readRawTxt(context, R.raw.vertex_shader);
        String fragmentSource = CjShaderUtil.readRawTxt(context, R.raw.fragment_yuv);
        program_yuv = CjShaderUtil.createProgram(vertexSource, fragmentSource);
    ...
    {
        String vertexSource = CjShaderUtil.readRawTxt(context, R.raw.vertex_shader);
        String fragmentSource = CjShaderUtil.readRawTxt(context, R.raw.fragment_mediacodec);
        program_mediacodec = CjShaderUtil.createProgram(vertexSource, fragmentSource);
